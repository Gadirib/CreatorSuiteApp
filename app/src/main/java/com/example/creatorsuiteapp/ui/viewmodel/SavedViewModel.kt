        ...
        viewModelScope.launch {
            ...
            runCatching {
                ...
                val sampleThumbs = listOf(
                    com.example.creatorsuiteapp.R.drawable.sample_img_1,
                    com.example.creatorsuiteapp.R.drawable.sample_img_2,
                    com.example.creatorsuiteapp.R.drawable.sample_video_1_thumb,
                    com.example.creatorsuiteapp.R.drawable.sample_video_2_thumb
                )
                val videos = saved.filter { it.type == "video" }.mapIndexed { i, _ ->
                    SavedVideoItem(
                        videoRes = com.example.creatorsuiteapp.R.raw.sample_video_1,
